...
import ru.malanyuk.test.ContactData;

public class NewContactCreating {
    FirefoxDriver wd;
    ...
    public void NewContactCreating() {
        ...
        initAddContact();
        fillContactForm(new ContactData("Marina", "Malaniuk", "Ahomia", "Artezio", "89873862557", "marina.malaniuk@gmail.com", 3, 2, "1992"));
